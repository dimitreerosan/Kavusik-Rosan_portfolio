      ...
      <div className="max-w-6xl mx-auto w-full relative z-10 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="md:col-span-5 space-y-12">
            <div>
              ...
              <div className="flex gap-6 mb-12">
                <a href="https://github.com/dimitreerosan" target="_blank" className="opacity-60 hover:opacity-100 transition-opacity">
                ...
                <a href="https://www.linkedin.com/in/kavusik-rosan-dimitree-creator-of-obscura-arcanum" target="_blank" className="opacity-60 hover:opacity-100 transition-opacity">
                ...
                <a href="mailto:kavusikbalu2006@gmail.com" className="opacity-60 hover:opacity-100 transition-opacity">
          ...
          <div className="md:col-span-7 lg:pl-10">
            <h2 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tight uppercase" style={{ letterSpacing: '-0.04em' }}>
              Send Us A Message
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-12" autoComplete="off">
              <div className="relative group">
                <input
                  ...
                  className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-4 text-white placeholder-neutral-800 focus:outline-none focus:border-white/60 text-lg font-light transition-colors"
                />
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-4 text-white placeholder-neutral-800 focus:outline-none focus:border-white/60 text-lg font-light transition-colors"
                />
                {errors.email && <p className="mt-2 font-sans text-sm font-light tracking-tight text-red-500/80">{errors.email}</p>}
              </div>
              ...
              <div className="relative group">
                <textarea
                  ...
                  onChange={handleChange}
                  rows="1"
                  className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-4 text-white placeholder-neutral-800 focus:outline-none focus:border-white/60 resize-none overflow-hidden text-lg font-light min-h-[60px] transition-colors"
                />
