          ...
          <div className="p-6 md:p-10 flex flex-col md:flex-row gap-8 md:gap-10">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-3 text-sm md:text-base leading-relaxed text-gray-400">
                Computer Science student, HCL GUVI Campus Ambassador and privacy engineer specializing in adversarial ML and AI-resistant
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="px-4 py-2 rounded-full bg-white/[0.04] border border-white/10 text-[10px] md:text-[11px] font-semibold tracking-[0.18em] uppercase text-gray-300">
        ...
        <div className="mt-8 space-y-8">
          <div className="flex items-start justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-white font-semibold text-sm md:text-base">BE in Computer Science & Engineering</p>
                <p className="text-gray-500 text-xs md:text-sm mt-1">Sri Shakthi Institute of Engineering and Technology</p>
              </div>
            </div>
            <p className="text-gray-600 text-xs md:text-sm mt-1 whitespace-nowrap">2023 - 2027</p>
          </div>
