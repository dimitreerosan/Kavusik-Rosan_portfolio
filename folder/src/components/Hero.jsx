  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen pt-24 pb-24 bg-black select-none overflow-hidden">
      ...
      <div className="hidden md:flex flex-col gap-3 absolute left-6 bottom-10 z-10">
        <button
          type="button"
          onClick={() => { window.location.href = 'mailto:kavusikbalu2006@gmail.com' }}
        ...
        <button
          type="button"
          onClick={() => window.open('https://github.com/dimitreerosan', '_blank', 'noopener,noreferrer')}
          className="p-2 rounded-md bg-white/5 hover:bg-white/10 border border-white/10 transition-colors"
          aria-label="GitHub"
        >
        ...
        <button
          type="button"
          onClick={() => window.open('https://www.linkedin.com/in/kavusik-rosan-dimitree-creator-of-obscura-arcanum', '_blank', 'noopener,noreferrer')}
          className="p-2 rounded-md bg-white/5 hover:bg-white/10 border border-white/10 transition-colors"
          aria-label="LinkedIn"
        >
          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
